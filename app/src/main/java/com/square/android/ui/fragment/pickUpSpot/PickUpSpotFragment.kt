...
class PickUpSpotFragment: BaseFragment(), PickUpSpotView, DaysAdapter.Handler{

    companion object {
        @Suppress("DEPRECATION")
        fun newInstance(campaign: Campaign): PickUpSpotFragment {
    ...
    @ProvidePresenter
    fun providePresenter(): PickUpSpotPresenter = PickUpSpotPresenter(getCampaign())
...
//        }
//
//        pickupAddressCl.setOnClickListener {
//            if(clickEnabled){
//                presenter.addressClicked()
//            }
//        }
    }
...
//        pickupAddressCl.visibility = View.VISIBLE
    }
