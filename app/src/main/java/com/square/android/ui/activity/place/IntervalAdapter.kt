...
import kotlinx.android.synthetic.main.item_interval.*

class IntervalAdapter(data: List<Place.Interval>,
                      private val handler: Handler?) : BaseAdapter<Place.Interval, IntervalAdapter.ViewHolder>(data) {

    var selectedItemPosition: Int? = null

    override fun getLayoutId(viewType: Int) = R.layout.item_interval
