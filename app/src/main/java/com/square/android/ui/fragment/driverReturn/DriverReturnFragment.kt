...
import com.square.android.ui.activity.event.LocationEvent
import com.square.android.ui.activity.event.LocationExtras
...
class DriverReturnFragment(private val driverExtras: DriverExtras): BaseNoMvpFragment() {
    ...
    private var intervals: MutableList<DriverRide> = driverExtras.returnIntervals.toMutableList()
