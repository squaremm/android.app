...
public class PermissionsManager {
    ...
    private final int REQUEST_PERMISSIONS_CODE = 1337;
    ...
    public void requestLocationPermissions(Fragment fragment) {
        ...
        checkForExplanations(fragment.getActivity(), permissions);
    ...
    private void requestPermissions(Activity activity, String[] permissions) {
        checkForExplanations(activity, permissions);

        ActivityCompat.requestPermissions(activity, permissions, REQUEST_PERMISSIONS_CODE);
    }

    private void checkForExplanations(Activity activity, String[] permissions) {
